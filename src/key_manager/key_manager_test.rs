...
mod key_manager_test {
    ...
    #[test]
    fn it_creates_new_128() {
        let key_manager = KeyManager::new_128(&[0x2b7e1516, 0x28aed2a6, 0xabf71588, 0x09cf4f3c]);
        assert_eq!(
            *key_manager.key(),
            vec![
    ...
    #[test]
    fn it_creates_new_192() {
        let key_manager = KeyManager::new_192(&[
    ...
    #[test]
    fn it_creates_new_256() {
        let key_manager = KeyManager::new_256(&[
